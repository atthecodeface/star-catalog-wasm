...
impl WasmOrbit {
    ...
    pub fn parent_to_orbit(&self) -> WasmQuatf64 {
    ...
    pub fn orbit_vec_of_unix_time(&self, time_secs: f64, v: &mut WasmVec3f64) {
        let f = self.orbit.orbit_vec_of_unix_time(time_secs as i64);
        *v = [f[0], f[1], 0.0].into();
    }
    pub fn orbit_vec_of_true_anomaly(&self, true_anomaly: f64, v: &mut WasmVec3f64) {
