    ...
    update_html_star_info() {
        if (this.selected_star) {
            ...
            if (name !== null && name !== undefined) {
                ...
                table.add_body([
                    html.HtmlElement.new_ele("span", {}, (e) => (e.innerText = "Name: <unnamed>")),
                ]);
            }
            table.add_body([
                html.HtmlElement.new_ele("span", {}, (e) => (e.innerText = `Id: ${star.id}`)),
            ]);
            table.add_body([
                html.HtmlElement.new_ele("span", {}, (e) => (e.innerText = `Mag: ${star.magnitude.toFixed(2)}`)),
            ]);
            table.add_body([
                html.HtmlElement.new_ele("span", {}, (e) => (e.innerText = `Ra: ${(star.right_ascension * this.rad2deg).toFixed(2)}`)),
            ]);
            table.add_body([
